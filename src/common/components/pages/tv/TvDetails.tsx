    ...
    <header className={`animate-pulse mb-28 pt-28`}>
      <div className="container flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          ...
          <h2 className="h-[20px] w-[150px] bg-secondary-base rounded mb-10"></h2>

          <h3 className="h-[28px] w-[150px] bg-secondary-base rounded mb-4"></h3>
          <p className="h-[18px] sm:w-[80%] bg-secondary-base rounded mb-1.5"></p>
          <p className="h-[18px] sm:w-[70%] bg-secondary-base rounded mb-1.5"></p>
          <p className="h-[18px] sm:w-[50%] bg-secondary-base rounded mb-20"></p>
  ...
  if (!isLoading && isSuccess && data) {
    ...
    return (
      <header
        ...
        className={`bg-no-repeat bg-fixed bg-cover before:block before:absolute before:bottom-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-b before:from-background-base/80 before:to-background-base before:backdrop-blur-[1px] before:z-[0] relative mb-28 pt-28`}
      >
        <div className="container flex flex-col md:flex-row z-[1] relative gap-10">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-lg text-background-content-muted mb-5">
              {data.tagline}
            </h2>
              ...
              {data.vote_average ? (
                <div className="relative">
                  <CircularProgress
                    ...
                    radius={38}
                    stroke={5}
                    foregroundClassName="stroke-primary-base fill-secondary-base/70"
              ...
              {data.genres ? (
                <div className="flex flex-wrap items-center gap-1">
                  {data.genres.map((genre) => (
                    <span
                      key={genre.id}
                      className="text-xs px-2 py-1 bg-primary-base rounded-sm"
                    >
                      {genre.name}
                    </span>
                  ))}
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-y-2 gap-x-5 mb-3 pb-2.5 border-b border-b-secondary-base">
              <div className="flex items-center gap-4">
                <b>Release Date:</b>
                <span className="text-background-content-muted">{date}</span>
              </div>
              <div className="flex items-center gap-4">
                <b>Average Episode Runtime:</b>
                <span className="text-background-content-muted">{runtime}</span>
              </div>
            </div>
            <div className="flex flex-col lg:flex-row lg:items-center gap-y-2 gap-x-5 mb-3 pb-2.5 border-b border-b-secondary-base">
              <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-y-2 gap-x-4 mb-3 pb-2.5 border-b border-b-secondary-base">
              <b>Languages:</b>
              <span className="text-background-content-muted">
                {data.languages.join(", ")}
              </span>
